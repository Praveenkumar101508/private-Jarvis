# freeze-cortex-vendor.ps1 — Phase 6: (re)populate + verify the frozen Cortex vendor copy.
#
# Downloads the pinned hermes-agent wheel into supracloud-jarvis/cortex-vendor/ and verifies
...
$vendor   = Join-Path $PSScriptRoot "..\cortex-vendor"
