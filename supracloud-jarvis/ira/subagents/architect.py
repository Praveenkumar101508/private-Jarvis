"""
ira/subagents/architect.py — IRA Evolution Team debate, ported to the Hermes bridge.
...
def _researcher(owner: str) -> str:
    return (
        ...
        "missing features; for each, compare what Grok/Claude/Gemini/ChatGPT do vs IRA's gap, and "
