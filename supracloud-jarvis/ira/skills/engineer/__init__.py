"""ira/skills/engineer/ — Engineer Mode (4-step diff-first workflow), ported as a Hermes skill (Option A).
...
NOTE: the original persona's codebase quick-reference described the pre-Hermes stack
(LangGraph/vLLM/Docker); refresh it for the Hermes/Ollama layout in a later pass.
"""
