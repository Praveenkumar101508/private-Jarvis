"""
ira/skills/security/ — Security Guardian, ported as a Cortex skill (Option A).
...
which sends the persona + that context through the Cortex bridge — replacing the old
...
def analyze_security(
    ...
    *,
    ...
    the out-of-process Cortex engine.
    """
    blocks = []
    if events:
        blocks.append(
