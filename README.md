# IRA — Legacy Codebase Archive

> **This branch is a read-only archive of the pre-restructure codebase (Phases 1–4).**
> Active development lives on `supracloud_ira`. Do not merge this branch.
